			...
			<Flex justify='space-between' ps='0px' pe='20px' pt='5px'>
				<Flex align='center' w='100%'>
					<Button bg={boxBg} fontSize='sm' fontWeight='500' color={textColorSecondary} borderRadius='7px'>
						<Icon as={MdOutlineCalendarToday as unknown as React.ElementType} color={textColorSecondary} me='4px' />
						This month
					</Button>
					<Button
						ms='auto'
			...
			<Flex w='100%' flexDirection={{ base: 'column', lg: 'row' }}>
				<Flex flexDirection='column' me='20px' mt='28px'>
					...
					<Flex align='center' mb='20px'>
						...
						<Flex align='center'>
							<Icon as={RiArrowUpSFill as unknown as React.ElementType} color='green.500' me='2px' mt='2px' />
					...
					<Flex align='center'>
						<Icon as={IoCheckmarkCircle as unknown as React.ElementType} color='green.500' me='4px' />
