		...
		<Card p='20px' alignItems='center' flexDirection='column' w='100%' {...rest}>
			<Flex alignItems='center' w='100%' mb='30px'>
				<IconBox
					...
					h='38px'
					bg={boxBg}
					icon={<Icon as={MdCheckBox as unknown as React.ElementType} color={brandColor} w='24px' h='24px' />}
				/>
			...
			<Box px='11px' w='100%'>
				<Flex w='100%' justify='space-between' mb='20px'>
					...
					<Icon ms='auto' as={MdDragIndicator as unknown as React.ElementType} color='secondaryGray.600' w='24px' h='24px' />
				</Flex>
				<Flex w='100%' justify='space-between' mb='20px'>
