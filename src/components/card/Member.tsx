			...
			<Flex align='center'>
				<Flex justifyContent='center' alignItems='center'>
					...
					<Flex direction='column' align='start'>
						<Text color={textColor} fontSize={{ base: 'md', xl: 'sm', '3xl': 'md' }} fontWeight='700'>
							{name}
						</Text>
						<Text
				...
				<TransparentMenu
					ms='auto'
					mb='0px'
					icon={<Icon as={IoEllipsisVertical as unknown as React.ElementType} w='24px' h='24px' color={textColor} />}
				/>
			</Flex>
		</Card>
	);
